                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <select name="country" id="country" class="form-control">
                                            ...
                                            <option {{ !empty($customerAddress) && $customerAddress->country_id ==
                                                $country->id ? 'selected' : '' }}
                ...
                <div class="col-md-4">
                    ...
                    <div class="card cart-summery">
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <div class="h6"><strong id="shippingAmount">${{ number_format($totalShipping, 2) }}</strong>
                            </div>
                        </div>
                    ...
                    <div class="input-group apply-coupan mt-4">
                        <input name="discount_code" id="discount_code" type="text" placeholder="Coupon Code"
                            class="form-control">
                    ...
                    <div id="discount-response-wrapper">
                        @if (Session::has('code'))
                        <div class="mt-4 d-flex align-content-center gap-1" id="discount-response">
                            <strong class="fs-5">{{ Session::get('code')->code }}</strong>
                            <button class="btn btn-sm btn-danger" id="remove-discount"><i
