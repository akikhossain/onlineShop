...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Discount Coupon Code List</h1>
            </div>
            ...
            <form action="" method="get">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{ route('coupon.list') }}'"
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ (!empty($coupon->starts_at)) ?
                                \Carbon\Carbon::parse($coupon->starts_at)->format('Y/m/d
                                H:i:s') : ''}}
                            </td>
                            <td>{{ (!empty($coupon->expires_at)) ?
