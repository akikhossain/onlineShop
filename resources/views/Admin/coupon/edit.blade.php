                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $discountCoupon->code }}" type="text" name="code" id="code"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $discountCoupon->name }}" type="text" name="name" id="name"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $discountCoupon->max_uses }}" type="number" name="max_uses"
                                    id="max_uses" class="form-control" placeholder="Max Uses"></input>
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $discountCoupon->max_uses_user }}" type="text" name="max_uses_user"
                                    id="max_uses_user" class="form-control" placeholder="Max Uses User"></input>
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="type" id="type" class="form-control">
                                    ...
                                    <option {{ ( $discountCoupon->type == 'fixed') ? 'selected' :'' }}
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $discountCoupon->discount_amount }}" type="text" name="discount_amount"
                                    id="discount_amount" class="form-control" placeholder="Discount Amount"></input>
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $discountCoupon->min_amount }}" type="text" name="min_amount"
                                    id="min_amount" class="form-control" placeholder="Minimum Amount"></input>
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option {{ ( $discountCoupon->status == 1) ? 'selected' :'' }} value="1">Active
                                    </option>
                                    <option {{ ( $discountCoupon->status == 0) ? 'selected' :'' }} value="0">Block
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $discountCoupon->starts_at }}" autocomplete="off" type="text"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $discountCoupon->expires_at }}" autocomplete="off" type="text"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea type="text" name="description" id="description" class="form-control"
                                    ...
                                    rows="10">{{ $discountCoupon->description }}</textarea>
                                <p></p>
                            </div>
                        </div>
                    </div>
