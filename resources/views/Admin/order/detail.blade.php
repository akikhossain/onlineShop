...
<section class="content">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card">
                    <form action="" method="post" id="changeStatusForm" class="changeStatusForm">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option value="" {{ $order->status == 'cancelled' ? 'selected' : '' }}>
                                        Cancelled</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <input placeholder="shipped date" value="{{ $order->shipped_date }}" type="text"
                                    id="shipped_date" name="shipped_date" class="form-control">
                            </div>
                            <div class="mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="" method="post" id="sendInvoiceEmail" class="sendInvoiceEmail">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.changeStatusForm').on('submit', function(e) {
            ...
            if(confirm('Are you sure to update order status?')){
                $.ajax({
                    url: "{{ route('orders.changeStatusForm', $order->id) }}",
                    type: "POST",
                    data: formData,
                    dataType: "json",
        ...
        $('.sendInvoiceEmail').on('submit', function(e) {
            e.preventDefault();
            var formData = $(this).serialize();
            if(confirm('Are you sure to send invoice email?')){
                $.ajax({
